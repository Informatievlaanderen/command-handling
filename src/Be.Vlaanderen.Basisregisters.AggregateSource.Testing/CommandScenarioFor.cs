namespace Be.Vlaanderen.Basisregisters.AggregateSource.Testing
{
        ...
        where TAggregateRoot : IAggregateRootEntity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Be.Vlaanderen.Basisregisters.AggregateSource.Testing.CommandScenarioFor`1" /> class.
        /// </summary>
        ...
        public IAggregateCommandGivenNoneStateBuilder<TAggregateRoot> GivenNone()
            => new AggregateCommandGivenNoneStateBuilder<TAggregateRoot>(_sutFactory);
