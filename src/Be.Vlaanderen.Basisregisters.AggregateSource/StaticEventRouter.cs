namespace Be.Vlaanderen.Basisregisters.AggregateSource
{
    ...
    public class StaticEventRouter : IConfigureStaticEventRouter
    {
        ...
        /// </summary>
        public StaticEventRouter() => _index = new Dictionary<Type, Dictionary<Type, Action<object, object>>>();
        ...
        public void ConfigureRoute<TInstance, TEvent>(Action<TInstance, TEvent> handler)
        {
            ...
            if (!_index.TryGetValue(typeof(TInstance), out var handlers))
            {
        ...
        public void ConfigureRoute(Type instance, Type @event, Action<object, object> handler)
        {
            ...
            if (!_index.TryGetValue(instance, out var handlers))
            {
                handlers = new Dictionary<Type, Action<object, object>>();
        ...
        public void Route(object instance, object @event)
        {
            ...
            if (!_index.TryGetValue(instance.GetType(), out var handlers))
                return;
