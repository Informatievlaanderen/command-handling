namespace Be.Vlaanderen.Basisregisters.SnapshotVerifier.Tests.GivenPublicMemberDiffers
{
    ...
    public class WhenPublicMemberIsIgnored
    {
        private readonly SnapshotVerifier<FakeAggregate, FakeAggregateStreamId> _snapshotVerifier;
        private readonly List<string> _membersToIgnore = new() { nameof(FakeAggregate.PublicMember) };
        ...
        public WhenPublicMemberIsIgnored()
        {
            ...
            var aggregateByEvents = aggregateBySnapshot.WithDifferentPublicMember(2);
