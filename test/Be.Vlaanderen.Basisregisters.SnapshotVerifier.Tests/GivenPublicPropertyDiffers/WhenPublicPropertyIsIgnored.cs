namespace Be.Vlaanderen.Basisregisters.SnapshotVerifier.Tests.GivenPublicPropertyDiffers
{
    ...
    public class WhenPublicPropertyIsIgnored
    {
        private readonly SnapshotVerifier<FakeAggregate, FakeAggregateStreamId> _snapshotVerifier;
        private readonly List<string> _membersToIgnore = new() { nameof(FakeAggregate.PublicProperty) };
        ...
        public WhenPublicPropertyIsIgnored()
        {
            ...
            var aggregateByEvents = aggregateBySnapshot.WithDifferentPublicProperty(2);
            ...
            _snapshotVerifier = new SnapshotVerifier<FakeAggregate, FakeAggregateStreamId>(
                ...
                DefaultComparisonConfig.Instance.WithMembersToIgnore(_membersToIgnore),
